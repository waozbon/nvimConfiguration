return {
  ...
  -- ========== UI y Apariencia ==========
  {
    ...
    config = function()
      require("user.theme").setup() -- Llama a la configuración del tema
    end,
  },
  {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<S-l>', ':BufferLineCycleNext<CR>', { desc = "Siguiente buffer (BufferLine)" })
      vim.keymap.set('n', '<S-h>', ':BufferLineCyclePrev<CR>', { desc = "Buffer anterior (BufferLine)" })
    ...
    config = function()
      require("gitsigns").setup({
        ...
        on_attach = function(bufnr)
          ...
          map("n", "<leader>hb", function() gs.blame_line { full = true } end, { desc = "Blame Line (Git)" })
          map("n", "<leader>tb", gs.toggle_current_line_blame, { desc = "Toggle Blame Line (Git)" })
          map("n", "<leader>hd", gs.diffthis, { desc = "Diff This (Git)" })
          map("n", "<leader>hD", function() gs.diffthis("~") end, { desc = "Diff This ~ (Git)" })
  ...
  -- ========== Fuzzy Finder (Telescope) ==========
  {
    ...
    config = function()
      require("user.telescope").setup() -- Llama a la configuración de telescope
    end,
  },
  ...
  -- ========== Treesitter (Mejor resaltado de sintaxis, etc.) ==========
  {
    ...
    build = ":TSUpdate",
    config = function()
      require("user.treesitter").setup() -- Llama a la configuración de treesitter
    end,
  },
  ...
  -- ========== LSP (Language Server Protocol) ==========
  {
    ...
    config = function()
      require("user.lsp").setup() -- Llama a la configuración de LSP
    end,
  },
  ...
  -- ========== Autocompletado (nvim-cmp) ==========
  {
    ...
    config = function()
      require("user.cmp").setup() -- Llama a la configuración de nvim-cmp
    end,
  },
}
